...
python3 utils/renderObjectArray.py -i outputs/m0.txt -o outputs/m0.png --pinSize 3.5 --dpi 480 -v & pids+=($!)
python3 utils/renderObjectArray.py -i outputs/m1.txt -o outputs/m1.png --pinSize 3.5 --dpi 480 -v & pids+=($!)
python3 utils/renderObjectArray.py -i outputs/m2.txt -o outputs/m2.png --pinSize 3.5 --dpi 480 -v & pids+=($!)
